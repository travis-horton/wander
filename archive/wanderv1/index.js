if (document.querySelector('p')) {
  ...
  c.style.backgroundColor = `rgb(20,20,20)`;
...
;(function() {
  ...
  let screens = new Array().fill(null);
  ...
  function attack(origin) {
    ...
    Swing.prototype = {
      draw() {
        ...
        let lineStart = this.origin.coord.minus(new V(warriorSize.x, warriorSize.y));
        let lineEnd = new V(lineStart.x - warriorSize.x, lineStart.y-warriorSize.y);
        ctx.beginPath();
  ...
  function Fb(origin) {
    ...
    this.v = new V(this.d.x, this.d.y).norm().times(2);
